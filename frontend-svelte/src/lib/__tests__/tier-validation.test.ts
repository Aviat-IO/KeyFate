/**
 * Tests for tier validation utilities
 *
 * Ported from frontend/src/lib/__tests__/tier-validation.test.ts
 * Framework-agnostic — only depends on $lib/types/subscription for the type.
 */
