				...
				<a href="/blog/{post.slug}">
					<Card.Root class="group transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
						<Card.Header>
							...
							<Card.Title class="group-hover:text-primary text-2xl transition-colors md:text-3xl">
								{post.title}
							</Card.Title>
						...
						<Card.Content>
							...
							<div class="text-primary mt-4 flex items-center gap-1 font-medium">
								Read article
				...
				<a href="/blog/{post.slug}">
					...
					>
						<Card.Header>
							...
							<Card.Title class="group-hover:text-primary line-clamp-2 transition-colors">
								{post.title}
							</Card.Title>
