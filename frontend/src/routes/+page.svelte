...
<div class="bg-background min-h-screen">
	...
	<section class="relative container mx-auto overflow-hidden px-4 py-32">
		<div class="absolute inset-0 opacity-5" style="transform: translateY({scrollY * 0.3}px)">
			<div class="bg-primary/20 absolute top-1/4 left-1/4 h-96 w-96 rounded-full blur-3xl"></div>
			<div
				class="bg-secondary/30 absolute right-1/4 bottom-1/4 h-64 w-64 rounded-full blur-2xl"
			></div>
		</div>
		...
		<div class="relative z-10 mx-auto max-w-5xl text-center">
			...
			<h1 class="mb-8 text-5xl font-bold tracking-tight md:text-7xl">
				...
				<span class="text-primary relative">
					Legacy
					<div class="bg-primary/30 absolute right-0 -bottom-2 left-0 h-1 rounded-full"></div>
				</span>
				Protected
			</h1>
		...
		<div class="mx-auto grid max-w-6xl gap-8 lg:grid-cols-3">
			<div class="group text-center">
				...
				<p class="text-muted-foreground">
					Your secret is split into 3 encrypted pieces using <strong>Shamir's Secret Sharing</strong
			...
			<Card.Root class="bg-muted/50 border-primary/20 mx-auto max-w-2xl">
				<Card.Content class="pt-6">
					...
					<p class="text-muted-foreground text-sm">
						<strong>We mathematically cannot read your secrets.</strong> Even if our servers were compromised,
						your information remains secure. Only you and your chosen recipients can reconstruct the original
						data.
					</p>
				</Card.Content>
			</Card.Root>
	...
	<section class="bg-muted/30 container mx-auto px-4 py-24">
		...
		<div class="mx-auto grid max-w-6xl grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
			{#each [{ icon: Shield, title: 'Military-Grade Encryption', desc: "AES-256 encryption with client-side Shamir's Secret Sharing", body: 'Your secrets are encrypted with the same standards used by governments and militaries. The cryptographic splitting happens entirely in your browser.' }, { icon: Clock, title: 'Flexible Check-ins', desc: 'Set your own schedule from daily to yearly', body: 'Choose check-in intervals that work for your lifestyle. Get gentle reminders before deadlines. One-click check-ins from anywhere.' }, { icon: Users, title: 'Trusted Recipients', desc: 'Verify recipients and customize delivery messages', body: "Email verification ensures your secrets reach the right people. Add custom instructions to help recipients understand what they're receiving." }, { icon: Zap, title: 'Instant Setup', desc: 'Start protecting your secrets in under 5 minutes', body: 'Quick and simple signup process. No complex configuration. Our intuitive interface guides you through creating your first secret.' }, { icon: Globe, title: 'Global Reliability', desc: 'Robust infrastructure with worldwide availability', body: 'Built on modern cloud infrastructure. Your check-ins and notifications work reliably from anywhere in the world.' }, { icon: Eye, title: 'Full Transparency', desc: 'Open-source cryptography with audit trail', body: 'Our encryption methods are based on proven, open-source algorithms. Full audit logs show exactly when and how your secrets are accessed.' }] as feature}
