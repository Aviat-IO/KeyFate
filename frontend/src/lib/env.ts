...
const PARENT_COMPANY =
	getEnvVar('PUBLIC_PARENT_COMPANY', false) || getEnvVar('NEXT_PUBLIC_PARENT_COMPANY', false);
const STRIPE_PUBLISHABLE_KEY =
	getEnvVar('PUBLIC_STRIPE_PUBLISHABLE_KEY', false) ||
	getEnvVar('NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY', false);
