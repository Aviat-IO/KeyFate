		...
		<div class="space-y-4 py-4">
			...
			<div class="border-destructive/30 bg-destructive/5 rounded-lg border p-4">
				<div class="flex gap-2">
					...
					<div>
						<h4 class="text-foreground font-medium">Security Notice</h4>
			...
			{#if success}
				<div class="border-primary/50 bg-primary/10 rounded-lg border p-4">
					<p class="text-primary text-sm">Recovery kit downloaded successfully!</p>
				</div>
			{/if}
		</div>
