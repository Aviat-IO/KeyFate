...
<div class="space-y-8 {className}">
	...
	<div class="space-y-4 text-center">
		...
		{#if isTest}
			<div class="bg-warning/10 text-warning border-warning mx-auto max-w-md rounded-lg border p-3">
		...
		<div class="grid gap-6">
			<div class="space-y-2">
				...
				<p class="text-muted-foreground text-sm">
					...
					continue to work, but you won't be able to create new ones until you upgrade or remove
					some existing secrets.
				</p>
			</div>
