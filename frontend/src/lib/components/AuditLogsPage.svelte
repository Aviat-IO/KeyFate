...
<div class="space-y-6">
	...
	<div class="flex flex-wrap gap-4">
		...
		<Input type="date" placeholder="Start Date" bind:value={startDateStr} class="w-[200px]" />
	...
	<div class="rounded-md border">
		<Table.Root>
			<Table.Header>
				<Table.Row>
					<Table.Head class="text-muted-foreground text-xs">Event</Table.Head>
					<Table.Head class="text-muted-foreground text-xs">Category</Table.Head>
					<Table.Head class="text-muted-foreground text-xs">Resource</Table.Head>
					<Table.Head class="text-muted-foreground text-xs">Date</Table.Head>
					<Table.Head class="text-muted-foreground text-xs">IP Address</Table.Head>
				</Table.Row>
			</Table.Header>
			<Table.Body>
				{#if loading}
				...
				{:else if logs.length === 0}
					<Table.Row>
						<Table.Cell colspan={5} class="text-muted-foreground text-center text-sm"
							>No audit logs found</Table.Cell
						>
					</Table.Row>
				{:else}
					{#each logs as log}
