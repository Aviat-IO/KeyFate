...
<div class="space-y-6">
	...
	{#if serverShareDeleted}
		<Alert.Root variant="destructive">
			...
			<Alert.Description>
				<strong>Secret Disabled:</strong> The server share has been deleted and this secret has been automatically
				paused. No reminder emails will be sent.
			</Alert.Description>
		</Alert.Root>
	{/if}
							...
							<Dialog.Root bind:open={showDeleteDialog}>
								...
								<Dialog.Content>
									...
									<Alert.Root variant="destructive">
										<AlertTriangle class="h-4 w-4" />
										<Alert.Description>
											<strong>Warning:</strong> After deletion, the server will no longer be able to provide
											its share to recipients.
										</Alert.Description>
									</Alert.Root>
									<Dialog.Footer>
	...
	<div class="flex justify-end space-x-4">
		<Button variant="outline" onclick={() => goto('/dashboard')} class="font-semibold"
